...
const KB: KBEntry[] = [
  {
    ...
    reply: {
      ...
      recommendedLessonId: "when-not-to-invest",
      recommendedLabel: "When NOT to invest yet",
    },
  },
  {
    ...
    reply: {
      ...
      recommendedLessonId: "etfs",
      recommendedLabel: "ETFs: a basket in one click",
    },
  },
  {
    ...
    reply: {
      ...
      recommendedLessonId: "roth-ira",
      recommendedLabel: "The Roth IRA: a student's secret weapon",
    },
  },
  {
  ...
  },
  {
    ...
    reply: {
      ...
      recommendedLessonId: "stocks",
      recommendedLabel: "Stocks: owning a slice",
    },
  },
  {
    ...
    reply: {
      ...
      recommendedLessonId: "compound-interest",
      recommendedLabel: "Compound interest: the snowball",
    },
  },
  {
    ...
    reply: {
      ...
      recommendedLessonId: "budgeting-college",
      recommendedLabel: "Budgeting in college",
    },
  },
  {
...
const FALLBACK: CoachReply = {
  ...
  recommendedLessonId: "what-is-investing",
  recommendedLabel: "What is investing, really?",
};
